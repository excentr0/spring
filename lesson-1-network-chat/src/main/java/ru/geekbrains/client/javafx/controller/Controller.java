...
public class Controller implements Initializable, MessageReciever {
  ...
  @FXML public ListView<TextMessage> lvMessages;

  @FXML public Button btSendMessage;
  ...
  @FXML public ListView<String> lvUserList;
  ...
  public void sendAuth() {
    try {
      ...
      ex.printStackTrace();
      showModalAlert("Сетевой чат", "Авторизация", "Ошибка авторизации", Alert.AlertType.ERROR);
      return;
    } catch (IOException ex) {
      ex.printStackTrace();
      showModalAlert("Сетевой чат", "Авторизация", "Ошибка сети", Alert.AlertType.ERROR);
      return;
    }
  ...
  private static void showModalAlert(
      String title, String header, String message, Alert.AlertType alertType) {
